...
def create_geometry_slide(report, image_format=None):
    """
    ...
    """
    img_path = export_geometry_image(image_format)
...
def create_analysis_parameters_slide(report, analysis=None, image_format=None):
    """
    ...
    img_path = export_analysis_overview_image(analysis, image_format)
